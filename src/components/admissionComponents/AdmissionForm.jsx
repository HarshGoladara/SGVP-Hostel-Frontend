...
import { storage } from '../../firebase_config/firebase.js'; // Adjust the import according to your file structure
...
const AdmissionForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (photoFile.studentPhotoFile) {
                studentPhotoUrl = await uploadImage(photoFile.studentPhotoFile, `students/${formData.pin_number}/student_photo`);
            }

            // Upload father photo to Firebase and get the URL
            let fatherPhotoUrl = '';
            if (photoFile.fatherPhotoFile) {
                fatherPhotoUrl = await uploadImage(photoFile.fatherPhotoFile, `students/${formData.pin_number}/father_photo`);
            }

            // Upload mother photo to Firebase and get the URL
            let motherPhotoUrl = '';
            if (photoFile.motherPhotoFile) {
                motherPhotoUrl = await uploadImage(photoFile.motherPhotoFile, `students/${formData.pin_number}/mother_photo`);
            }
            ...
            const response = await axios.post('http://localhost:5000/api/admission/addStudent', updatedFormData);
    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="max-w-4xl mx-auto p-8 bg-slate-400 shadow-lg rounded-lg mt-8">
                <h1 className="text-3xl font-bold mb-8 text-center text-gray-800">Admission Form</h1>

                {/* Student Data Section */}
                <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mb-10">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Student Data</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label className="block text-sm text-gray-700">Student Full Name</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm text-gray-700">Postal Pin Number</label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-sm text-gray-700">Student Contact Number</label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-sm text-gray-700">Student Qualification</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm text-gray-700">Upload Student Photo</label>
                            <input
                                type="file"
                ...
                <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mb-10">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Add Student Education</h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-4">
                        {/* Name of University */}
                        <div>
                            <label className="block text-gray-600 mb-1">Name of University:</label>
                            <input
                                type="text"
                        ...
                        {/* Name of College */}
                        <div>
                            <label className="block text-gray-600 mb-1">Name of College:</label>
                            <input
                                type="text"
                        ...
                        {/* Course Duration */}
                        <div>
                            <label className="block text-gray-600 mb-1">Course Duration (Years):</label>
                            <input
                                type="number"
                ...
                <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mb-10">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Add Parent Details</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-4">
                        ...
                        <div>
                            <label className="block text-gray-600 mb-1">Father Contact Number:</label>
                            <input
                                type="number"
                        ...
                        {/* Father Photo URL */}
                        <div>
                            <label className="block text-gray-600 mb-1">Upload Father Photo:</label>
                            <input
                                type="file"
                        ...
                        <div>
                            <label className="block text-gray-600 mb-1">Mother Contact Number:</label>
                            <input
                                type="number"
                        ...
                        {/* Mother Photo URL */}
                        <div>
                            <label className="block text-gray-600 mb-1">Upload Mother Photo:</label>
                            <input
                                type="file"
                        ...
                        <div>
                            <label className="block text-gray-600 mb-1">Approval Person Name:</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-gray-600 mb-1">Approval Person Contact:</label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-gray-600 mb-1">Approval Person Relation:</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-gray-600 mb-1">Approval Person Email:</label>
                            <input
                                type="email"
                ...
                <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mb-10">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Add Relative Details</h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-4">
                        {/* Relative's Full Name */}
                        <div>
                            <label className="block text-gray-600 mb-1">Relative's Full Name:</label>
                            <input
                                type="text"
                                name="relative_name"
                        ...
                        <div>
                            <label className="block text-gray-600 mb-1">Relative Contact Number:</label>
                            <input
                                type="number"
                        ...
                        {/* Relative Address */}
                        <div className="md:col-span-2 lg:col-span-3">
                            <label className="block text-gray-600 mb-1">Relative Address:</label>
                            <textarea
                ...
                <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mb-10">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Add Sant Reference</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        ...
                        {/* Sant Phone Number */}
                        <div>
                            <label className="block text-gray-600 mb-1">Sant Phone Number:</label>
                            <input
                                type="number"
                ...
                <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mb-10">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Add Relative Reference</h2>
