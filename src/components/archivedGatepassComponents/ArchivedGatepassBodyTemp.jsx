...
import './css/ArchivedGatepassStyle.css'; // Import your custom styles
import { VITE_BACKEND_BASE_API } from '../../helper/envConfig/envConfig';

const ArchivedGatepassBodyTemp = () => {
  const [gatepasses, setGatepasses] = useState([]);

  useEffect(() => {
    // Fetching data from the API
    axios
      .get(`${VITE_BACKEND_BASE_API}/gatepass/getGatepassFromArchived`)
      .then((response) => {
...
export default ArchivedGatepassBodyTemp;
