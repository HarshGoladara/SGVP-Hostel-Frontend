...
const AlumniStudentTable = ({
  ...
  const handleConfirmMoveBackToSGVP = (student) => {
  ...
  const handleConfirmDialogYes = async () => {
    if (studentToMove) {
      await handleMoveBackToSGVPAction(studentToMove);
    }
                    ...
                    <ActionDropdown
                      onActionSelect={(action) => {
                        if (action === 'Show') {
                          ...
                          handleConfirmMoveBackToSGVP(student);
                        }
                      }}
                    />
                  </td>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="confirm-dialog-description">
            ...
            <strong>{studentToMove?.student_full_name || 'Student'}</strong>{' '}
            Back to SGVP?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
